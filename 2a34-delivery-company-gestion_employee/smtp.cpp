...
void Smtp::stateChanged(QAbstractSocket::SocketState socketState)
{
    ...
    if (socketState == QAbstractSocket::UnconnectedState && socket->error() != QAbstractSocket::UnknownSocketError) {
        qDebug() << "Connection error: " << socket->errorString();
        emit status(tr("Connection error: ") + socket->errorString());
    }
}
